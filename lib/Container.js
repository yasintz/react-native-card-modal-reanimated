...
function Container(props) {
    ...
    return (<View style={[styles.container, (_a = props.styleOverrides) === null || _a === void 0 ? void 0 : _a.container]}>
      {props.renderBackground && (<Animated.View style={[
        ...
        (_b = props.styleOverrides) === null || _b === void 0 ? void 0 : _b.childrenWrapper,
    ]}>
          {children}
          <Animated.View pointerEvents="none" style={[
        StyleSheet.absoluteFill,
        { backgroundColor: 'black', opacity },
        (_c = props.styleOverrides) === null || _c === void 0 ? void 0 : _c.childrenSibling,
    ]}></Animated.View>
        </Animated.View>)}
