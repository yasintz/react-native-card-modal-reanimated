...
function Container(props: Props) {
  ...
  const lastModalRefCreate = useMemo(
    () => (ref: LastModalRef) => {
    ...
    forwardRef({
      ...
      closeModal: (name?: string) => {
        ...
        if (name && opened[opened.length - 1] !== name) {
          console.warn(
            `you should close the last modal first! Now modals stack: ${opened}`
          );
          return;
        }
  ...
  return (
    <View style={[styles.container, props.styleOverrides?.container]}>
      {props.renderBackground && (
        <Animated.View
          style={[
            ...
            props.styleOverrides?.childrenWrapper,
          ]}
        >
          {children}
          <Animated.View
            ...
            style={[
              ...
              props.styleOverrides?.childrenSibling,
            ]}
          ></Animated.View>
        </Animated.View>
      )}
